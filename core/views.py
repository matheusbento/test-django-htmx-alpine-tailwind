...
from core.models import Fixture, Prediction, Team
...
def submit_prediction(request, fixture_pk):
    ...
    if prediction:
        ...
        prediction = Prediction.objects.create(fixture=fixture, user=request.user, home_goals=home_goals, away_goals=away_goals)
